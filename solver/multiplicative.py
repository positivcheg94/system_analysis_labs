...
from .private.constants import DEFAULT_FLOAT_TYPE, CONST_EPS, CONST_EPS_LOG
...
def __calculate_error_for_degrees__(degrees, x_normed_matrix, y_normed_matrix, ln_y_add_one, y_matrix, b_matrix, dims_x_i,
